...
/*   Updated: 2023/05/04 14:32:06 by rrask            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	empty_placement(t_game *game, int x, int y)
{
	...
	{
		mlx_put_image_to_window(game->mlx, game->win, game->empty, x * 32,
			y * 32);
	}
}
...
void	sprite_placement(t_game *game, int x, int y)
{
	if (game->map[game->y][game->x] == '1')
		mlx_put_image_to_window(game->mlx, game->win, game->wall, x * 32,
			y * 32);

	if (game->map[game->y][game->x] == 'E')
		mlx_put_image_to_window(game->mlx, game->win, game->exit, x * 32,
			y * 32);
